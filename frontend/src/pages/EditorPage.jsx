  ...
  const tabItems = useMemo(() => [
    {
      ...
      children: (
        <Card>
          ...
          <ChapterManagement projectId={projectId} onChapterSelect={handleChapterSelect} onChaptersChange={loadChapters} />
        </Card>
      ),
    },
    {
        ...
        <div style={{ height: 'calc(100vh - 200px)', minHeight: '600px' }}>
          {loading ? (
            ...
            <SplitScreenEditor
              ...
              onSave={handleSave}
              chapters={chapters}
              currentChapter={chapters.find(c => c.id === selectedChapterId)}
              onChapterSelect={handleChapterSelect}
              projectGoals={{
                daily_word_goal: projectInfo?.daily_word_goal || 2000,
                total_word_goal: projectInfo?.total_word_goal || 300000
              }}
            />
          ) : (
