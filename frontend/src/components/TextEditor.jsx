...
const TextEditor = ({ chapterId, initialContent, onSave, projectId, onWordCountChange, showOutline: showOutlineProp = true }) => {
  ...
  useEffect(() => {
    const updateHeight = () => {
      if (editorContainerRef.current) {
        const parentHeight = editorContainerRef.current.parentElement?.clientHeight || window.innerHeight;
        // 减去顶部工具栏和底部信息栏的高度
        const availableHeight = parentHeight - 120;
