...
const ProjectCreation = () => {
  ...
  const applyProposal = (proposal) => {
    setFormData(prev => ({
      ...
      pen_name: proposal.pen_name || prev.pen_name,
      genre: proposal.genre || prev.genre,
      target_audience: proposal.target_audience || prev.target_audience,
      core_theme: proposal.core_theme || prev.core_theme,
      synopsis: proposal.synopsis || prev.synopsis,
      writing_style: proposal.writing_style || prev.writing_style,
      reference_works: proposal.reference_works || prev.reference_works
    }));
  };
    ...
    return (
      <div className="step-content">
        <div className="step-header-with-action">
          <h3>基础信息填写</h3>
          <button
            className="ai-proposal-button"
            onClick={openProposalModal}
            title="使用AI根据创意生成项目信息"
          >
