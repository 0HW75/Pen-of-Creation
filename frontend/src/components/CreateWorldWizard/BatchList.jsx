...
const batchTypeConfig = {
  ...
  region: { title: '区域', icon: <EnvironmentOutlined />, color: '#13c2c2', priority: 'P1' },
  celestial_body: { title: '天体', icon: <GlobalOutlined />, color: '#fa541c', priority: 'P1' },
  natural_law: { title: '自然法则', icon: <GlobalOutlined />, color: '#fa8c16', priority: 'P1' },
  civilization: { title: '文明体系', icon: <BankOutlined />, color: '#13c2c2', priority: 'P1' },
  social_class: { title: '社会阶层', icon: <TeamOutlined />, color: '#722ed1', priority: 'P2' },
  political_system: { title: '政治体系', icon: <TeamOutlined />, color: '#eb2f96', priority: 'P2' },
  economic_system: { title: '经济体系', icon: <TeamOutlined />, color: '#13c2c2', priority: 'P2' },
  cultural_custom: { title: '文化习俗', icon: <BankOutlined />, color: '#fa541c', priority: 'P2' },
