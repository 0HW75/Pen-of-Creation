...
{{
    ...
    "gravity": "重力（如1.0G）"
            ...
            {
                'entity_type': 'world_architecture',
                'template_name': 'simple_world_architecture',
                'strategy': 'simple',
                'description': '简单世界架构生成模板',
                'variables': ['world_info', 'prompt', 'style'],
                'prompt_template': """基于以下世界观信息，创建一个简单的世界架构设定：
...
请生成一个世界架构设定（可以是维度、区域、天体或自然法则），包含以下字段（以JSON格式返回）：
{{
    "name": "架构名称",
    "architecture_type": "架构类型（维度/区域/天体/自然法则）",
    "description": "架构描述"
}}""",
                'version': 1,
                'is_default': True
            ...
            {
                'entity_type': 'world_architecture',
                'template_name': 'detailed_world_architecture',
                'strategy': 'detailed',
                'description': '详细世界架构生成模板',
                'variables': ['world_info', 'prompt', 'style', 'related_entities'],
                'prompt_template': """基于以下世界观信息，创建一个详细的世界架构设定：
...
请生成一个完整的世界架构设定，根据类型选择相应的字段（以JSON格式返回）：

如果是维度/位面：
{{
    "name": "维度名称",
    "architecture_type": "维度",
    "description": "维度描述",
    "dimension_type": "维度类型（主世界/位面/维度/异空间）",
    "entry_conditions": "进入条件",
    "physical_properties": "物理特性",
...
{{
    "name": "天体名称",
    "architecture_type": "天体",
    "description": "天体描述",
    "celestial_type": "天体类型（恒星/行星/卫星/小行星/星云等）",
    "position": "位置坐标",
    "size": "大小规模",
...
{{
    "name": "法则名称",
    "architecture_type": "自然法则",
    "description": "法则描述",
    "law_type": "法则类型（物理/魔法/时间/空间等）",
    "effects": "影响范围",
    "exceptions": "例外情况"
}}""",
                'version': 1,
